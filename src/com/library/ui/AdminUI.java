...
public class AdminUI {
    ...
    public void displayAdminMenu() {
        ...
        while (inAdmin) {
            ...
            switch (choice) {
                ...
                case 10: viewMemberTransactions(); break;
                case 11: undoLastTransaction(); break;
                case 12: viewAllAuthors(); break;
                case 13: inAdmin = false; break;
    ...
    private void searchBook() {
        ...
        if (results != null && !results.isEmpty()) {
            System.out.println("\nSearch Results:");
            for (Book book : results) System.out.println(book);
        } else {
